 ...
 *allowing prototype for function pointer structure.
 *@arg: string generated from getline containing potential arguements.
 ...
 *@environ: a custom modified copy of environ from the LL env.
 *@history: hist node.
 *@alias: alias node.
 *@env_changed: if environ was changed,
 *@status: return status of last executed cmd.
 *@cmd_buf: the address of the pointer to cmd_buf, if chaining.
...
/**
 *struct builtin - contain builtin str, related function.
