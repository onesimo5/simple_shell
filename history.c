 ...
 * Return:the allocated str containg history file.
 */
 ...
 * @info: the parameter structure.
 * Return: historycount on success or otherwise 0.
 */
...
/**
 * build_history_list - adds a entry to history linked list.
...
/**
 * renumber_history - history linked list after modifications.
 * @info: struct containing arguments.
